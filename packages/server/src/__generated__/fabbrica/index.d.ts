...
export interface PostFactoryInterface<TOptions extends PostFactoryDefineOptions = PostFactoryDefineOptions>
  extends PostFactoryInterfaceWithoutTraits {
 ...
 */
export declare function definePostFactory<TOptions extends PostFactoryDefineOptions>(
  options: TOptions,
): PostFactoryInterface<TOptions>;
